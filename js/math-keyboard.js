...
const TABS = {
  basic: {
    ...
    rows: [
      [
        { label: "a/b", insert: "\\frac{}{}", cls: "kb-op", cursor: -3 },
        { label: "x²", insert: "^2", cls: "kb-op" },
        { label: "xⁿ", insert: "^{}", cls: "kb-op", cursor: -1 },
        { label: "xₙ", insert: "_{}", cls: "kb-op", cursor: -1 },
        { label: "√", insert: "\\sqrt{}", cls: "kb-op", cursor: -1 },
        { label: "Σ", insert: "\\sum_{i=1}^{n}", cls: "kb-op" },
        { label: "∫", insert: "\\int_{}^{}", cls: "kb-op", cursor: -3 },
        { label: "lim", insert: "\\lim_{x \\to }", cls: "kb-op", cursor: -1 },
      ...
      [
        { label: "∏", insert: "\\prod_{i=1}^{n}", cls: "kb-op" },
        { label: "∂", insert: "\\partial", cls: "kb-op" },
        ...
        { label: "e^x", insert: "e^{}", cls: "kb-fn", cursor: -1 },
        { label: "ln", insert: "\\ln", cls: "kb-fn" },
        { label: "e", insert: "e", cls: "" },
        { label: "→", insert: "\\to", cls: "kb-op" },
      ],
    ],
  },
  latex: {
