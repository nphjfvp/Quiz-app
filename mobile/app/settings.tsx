  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: c.bg }]}>
      ...
      <View style={[styles.section, { backgroundColor: c.card }]}>
        ...
        <TouchableOpacity
          style={[styles.btn, { backgroundColor: c.primaryLight, marginTop: 10 }]}
          onPress={cloudSync}
        >
          <Text style={styles.btnText}>Cloud Sync</Text>
        </TouchableOpacity>

        <Text style={[styles.hint, { color: c.textLight }]}>
          {isConfigured()
            ? "Firebase ist konfiguriert. Daten werden automatisch synchronisiert."
            : "Firebase ist nicht konfiguriert. Konfiguriere die firebase.ts Datei für Cloud-Sync."}
        </Text>
      </View>
      ...
      <View style={[styles.section, { backgroundColor: c.card }]}>
        ...
        <Text style={[styles.hint, { color: c.textLight }]}>
          ...
          Exportiere Quizzes aus der Desktop-App als JSON und importiere sie hier.
        </Text>
      </View>
    </ScrollView>
  );
